...
<head>
    ...
    <link rel="stylesheet" href="https://unpkg.com/tailwindcss@%5E2/dist/tailwind.min.css" rel="stylesheet" />
    ...
    <div class="lg:w-2/4 mx-auto py-8 px-6 bg-white rounded-xl">
        ...
        <div class="mb-6">
            <form class="flex flex-col space-y-4" method="POST" action="/">
                ...
                <button class="w-28 py-4 px-8 bg-green-500 text-white rounded-xl">Add
                </button>
            ...
            @foreach ($todos as $todo)
                ...
                @class([
                    ...
                    <div class="flex-1 pr-8">
                        <h3 class="text-tg font-semibold">{{ $todo->title }}</h3>
                    ...
                    <div class="flex space-x-3">
                        <form method="POST" action="/{{ $todo->id }}">
                            ...
                            <button class="py-2 px-2 bg-green-500 text-white rounded-xl"><svg
                                    ...
                                    stroke-width="1.5" stroke="currentColor" class="h-6 W6-">
                        ...
                        <button class="py-2 px-2 bg-red-500 text-white rounded-xl"><svg
                                ...
                                stroke="currentColor" class="h-6 w6">
